...
def encontrar_faixa_azul(imagem, cor_alvo=(00, 00, 00), tolerancia=15, altura_faixa=10):
    """
...
def dividir_imagem_por_faixas(caminho_imagem, pasta_saida, cor_alvo=(00, 00, 00)):
    """
...
if __name__ == "__main__":
    ...
    caminho_imagem = "/home/administrador/Documentos/2007_amarela_enem/7Passo-DividirPelaFaixaAzul/colunas_concatenadas_verticalmente.png"  # Substitua pelo caminho da sua imagem
    
    pasta_saida = "questoes_colunaaaaaas" # Substitua pelo nome da pasta de saída desejada (questoes_colunas, pagina_15, pagina_28)
